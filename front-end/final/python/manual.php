...
See the <a href="walkthru.html">walkthrough</a> for a guided tour of the features and usage of the StarterPack.
						</p>
...
<code>maps/</code>, <code>samples/</code> (bots) are in <code>utilities</code> tar.
						...
						<p class="bold">
							Any changes to the starter packs will feature on the <a href="index.php#news">news</a> .<br>
...
# turn 27
						...
						<p>
							Login to your account on <span class="bob">bob</span> and navigate to the Submissions tab. Upload your <code>.py</code> file.
						</p>
